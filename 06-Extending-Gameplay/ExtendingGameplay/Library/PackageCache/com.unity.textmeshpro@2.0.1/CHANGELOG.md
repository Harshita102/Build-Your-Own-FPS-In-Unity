# Changelog
These are the release notes for the TextMesh Pro UPM package which was first introduced with Unity 2023.1. Please see the following link for the Release Notes for prior versions of TextMesh Pro. http://digitalnativestudios.com/forum/index.php?topic=1363.0
...
- The Glyph Adjustment Table presentation and internal data structure has been changed to facilitate the future addition of OpenType font features. See https://forum.unity.com/threads/version-1-4-0-preview-with-dynamic-sdf-for-unity-2023-3-now-available.622420/#post-4206595 for more details.
...
- Moved TMP Settings to universal settings window in 2023.3 and above.
...
## [1.2.1] - 2023-02-14
### Changes
- Package is now backwards compatible with Unity 2023.1.
...
## [1.2.0] - 2023-01-23
### Changes
- Package version # increased to 1.2.0 which is the first release for Unity 2023.2.

## [1.1.0] - 2023-01-23
### Changes
- Package version # increased to 1.1.0 which is the first release for Unity 2023.1. 
...
- Changed reference to PrefabUtility.GetPrefabParent() to PrefabUtility.GetCorrespondingObjectFromSource() to reflect public API change in 2023.2
...
## [1.0.26] - 2023-01-10
### Added
- Removed Tizen player references in the TMP_InputField as the Tizen player is no longer supported as of Unity 2023.1.
